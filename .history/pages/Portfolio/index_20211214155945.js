      ...
      <main className={styles.main}>
        ...
        <div className={styles.grid}>
          <a href="https://jjeongin.github.io/Chroma/" className={styles.card}>
            <h2>Paints</h2>
            <Image src="/images/favicons/apple-touch-icon.png" alt="Spaceman"></Image>
          </a>

          <a href="https://neomort.github.io/Mental-Healh-Oasis/" className={styles.card}>
            <h2>Sounds</h2>
            <Image src="/images/portfolio/sound.png" alt="Sound"></Image>
          </a>
          ...
          >
            <h2>String</h2>
            <Image src="/images/portfolio/string.png" alt="String"></Image>
          </a>
          ...
          >
            <h2>Comic</h2>
            <Image src="/images/portfolio/comic.png" alt="Comic"></Image>
          </a>
        </div>
      </main>
