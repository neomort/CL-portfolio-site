      ...
      <h1 className={styles.title}>
        ...
        <div className={styles.grid}>
          <a href="https://jjeongin.github.io/Chroma/" className={styles.card}>
            <h2>Paints</h2>
            <Image src="/images/portfolio/paints.png" alt="Paint" width={250} height={150}></Image>
          </a>

          <a href="https://neomort.github.io/Mental-Healh-Oasis/" className={styles.card}>
            <h2>Sounds</h2>
            <Image src="/images/portfolio/sound.png" alt="Sound" width={250} height={150}></Image>
          </a>
          ...
          >
            <h2>String</h2>
            <Image src="/images/portfolio/string.png" alt="String" width={250} height={150}></Image>
          </a>
          ...
          >
            <h2>Comic</h2>
            <Image src="/images/portfolio/comic.png" alt="Comic" width={250} height={150}></Image>
          </a>
        </div>
      </main>
