      ...
      <main className={styles.main}>
        ...
        <div className={styles.grid}>
          <a href="https://jjeongin.github.io/Chroma/" className={styles.card}>
            <h2>Paints</h2>
            <Image src="/images/portfolio/paints.png" alt="Paint" width={200} height={150}></Image>
          </a>

          <a href="https://neomort.github.io/Mental-Healh-Oasis/" className={styles.card}>
            <h2>Sounds</h2>
            <Image src="/images/portfolio/sound.png" alt="Sound" width={200} height={150}></Image>
          </a>
          ...
          >
            <h2>String</h2>
            <Image src="/images/portfolio/string.png" alt="String" width={200} height={150}></Image>
          </a>
          ...
          >
            <h2>Comic</h2>
            <Image src="/images/portfolio/comic.png" alt="Comic" width={200} height={150}></Image>
          </a>
        </div>
      </main>
